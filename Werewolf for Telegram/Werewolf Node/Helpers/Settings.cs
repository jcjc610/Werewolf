...
public static List<string> VillagerDieImages = new List<string> { "CgADBQADBwADTkJ0C8tzjcTmwJJdAg" };
        ...
        public static List<string> VillagersWin = new List<string> { "CgADBAAD8QgAAqIeZAdrpaRWB_YBNAI" };
        public static List<string> NoWinner = new List<string> { "CgADAwADgwADdBexB4WAJX1UUMcGAg", "CgADBAADuAMAAlUXZAcqbs8FFzH_jAI" };
        ...
        public static List<string> LoversWin = new List<string> { "CgADBAADYAMAAkMdZAcd_U89p6WSowI", "CgADBAAD8hUAAhYYZAf3gNsjhsQUUwI" };
